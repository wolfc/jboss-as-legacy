...
public class RemotingServiceAddStepHandler extends AbstractBoottimeAddStepHandler {
    ...
    Collection<ServiceController<?>> installRuntimeServices(final OperationContext context, final ModelNode operation,
        ...
        serviceBuilder.addDependency(SocketBinding.JBOSS_BINDING_NAME.append(bindingRefModel.asString()), SocketBinding.class, service.getBinding()) /*  .addDependency(LegacyInvokerService.SERVICE_NAME, UnifiedInvoker.class, service.getUnifiedInvoker())*/;
