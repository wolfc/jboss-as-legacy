...
import static org.jboss.legacy.jnp.JNPSubsystemNamespace.LEGACY_JNP_1_0;
 ...
 *
 */
public class JNPExtension implements Extension {
    ...
    public static final String NAMESPACE_1_0 = LEGACY_JNP_1_0.getUriString();

    public static ResourceDescriptionResolver getResourceDescriptionResolver(final String keyPrefix) {
        return new StandardResourceDescriptionResolver(keyPrefix, RESOURCE_NAME, JNPExtension.class.getClassLoader(), true, true);
    }
    @Override
    ...
    public void initializeParsers(ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, NAMESPACE_1_0, JNPSubsystem10Parser.INSTANCE);
    }
