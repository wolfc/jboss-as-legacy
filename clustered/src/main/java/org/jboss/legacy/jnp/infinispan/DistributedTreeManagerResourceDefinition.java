...
public class DistributedTreeManagerResourceDefinition extends SimpleResourceDefinition {
    ...
    private DistributedTreeManagerResourceDefinition() {
        super(PathElement.pathElement(DistributedTreeManagerModel.SERVICE, DistributedTreeManagerModel.SERVICE_NAME), JNPExtension
                .getResourceDescriptionResolver(DistributedTreeManagerModel.SERVICE_NAME), DistributedTreeManagerServiceAddStepHandler.INSTANCE,
                DistributedTreeManagerServiceRemoveStepHandler.INSTANCE);
    }
