 ...
 * @author baranowb
 */
public class LegacyEJB3RegistrarServiceAddStepHandler extends AbstractBoottimeAddStepHandler {

    public static final LegacyEJB3RegistrarServiceAddStepHandler INSTANCE = new LegacyEJB3RegistrarServiceAddStepHandler();

    public LegacyEJB3RegistrarServiceAddStepHandler() {
    }
    ...
    protected void performBoottime(OperationContext context, ModelNode operation, ModelNode model,
        ...
        context.addStep(new AbstractDeploymentChainStep() {
            ...
            protected void execute(DeploymentProcessorTarget processorTarget) {
                processorTarget.addDeploymentProcessor(LegacyEJB3Extension.SUBSYSTEM_NAME, Phase.INSTALL, 0, new LegacyEJB3DeploymentProcessor());
            }
    ...
    Collection<ServiceController<?>> installRuntimeServices(final OperationContext context, final ModelNode operation,
        ...
        final ServiceController<LegacyEJB3Registrar> registrarServiceController = serviceBuilder.install();
