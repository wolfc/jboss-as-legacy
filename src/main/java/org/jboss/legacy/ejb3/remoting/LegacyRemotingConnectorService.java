 ...
 *
 */
public class LegacyRemotingConnectorService implements Service<Connector>{
    ...
    public static final ServiceName SERVICE_NAME = ServiceName.JBOSS.append(LegacyRemotingModel.LEGACY).append(LegacyRemotingModel.SERVICE_NAME);

    public LegacyRemotingConnectorService(final String host, final int port) {
        super();
