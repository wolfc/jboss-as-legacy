 ...
 *
 */
public class LegacyRemotingServiceAddStepHandler extends AbstractBoottimeAddStepHandler {

    public static final LegacyRemotingServiceAddStepHandler INSTANCE = new LegacyRemotingServiceAddStepHandler();
    public LegacyRemotingServiceAddStepHandler() {
        super(LegacyRemotingResourceDefinition.HOST,LegacyRemotingResourceDefinition.PORT);
    }
    ...
    Collection<ServiceController<?>> installRuntimeServices(final OperationContext context,final ModelNode operation, final ModelNode model, final ServiceVerificationHandler verificationHandler) throws OperationFailedException {
        final String host = LegacyRemotingResourceDefinition.HOST.resolveModelAttribute(context, model).asString();
        final int port = LegacyRemotingResourceDefinition.PORT.resolveModelAttribute(context, model).asInt();
        final LegacyRemotingConnectorService service = new LegacyRemotingConnectorService(host, port);
